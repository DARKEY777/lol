...
API_ID = int(environ.get('API_ID', '22634052'))
API_HASH = environ.get('API_HASH', '035bfb2232b2a106ec465329d79f84dd')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/otF.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6062629823').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002283302175'))
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002475850637')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'lakkkicollection')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/otF.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movies_search_group_all')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+SJ2KokHDTQA3NDA1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movies_search_group_all') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '2d4bfb4733d593059dbb7a1b5e303c7dd38ea3ef')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Sk_entertains/18')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://yabbering-kelsey-lakki-27a8bc6a.koyeb.app/")
